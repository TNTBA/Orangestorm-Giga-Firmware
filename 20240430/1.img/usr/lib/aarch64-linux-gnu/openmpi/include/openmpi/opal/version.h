...
#define OPAL_CONFIGURE_CLI " \'--build=aarch64-linux-gnu\' \'--prefix=/usr\' '--includedir=\${prefix}/include' '--mandir=\${prefix}/share/man' '--infodir=\${prefix}/share/info' \'--sysconfdir=/etc\' \'--localstatedir=/var\' \'--disable-silent-rules\' '--libdir=\${prefix}/lib/aarch64-linux-gnu' '--libexecdir=\${prefix}/lib/aarch64-linux-gnu' \'--runstatedir=/run\' \'--disable-maintainer-mode\' \'--disable-dependency-tracking\' \'--disable-silent-rules\' \'--disable-wrapper-runpath\' \'--with-package-string=Debian OpenMPI\' \'--with-verbs\' \'--with-jdk-dir=/usr/lib/jvm/default-java\' \'--enable-mpi-java\' \'--enable-opal-btl-usnic-unit-tests\' \'--with-libevent=external\' \'--with-pmix=/usr/lib/aarch64-linux-gnu/pmix\' \'--disable-silent-rules\' \'--enable-mpi-cxx\' \'--with-hwloc=/usr\' \'--with-libltdl\' \'--with-devel-headers\' \'--with-slurm\' \'--with-sge\' \'--without-tm\' \'--sysconfdir=/etc/openmpi\' '--libdir=\${prefix}/lib/aarch64-linux-gnu/openmpi/lib' '--includedir=\${prefix}/lib/aarch64-linux-gnu/openmpi/include'"
